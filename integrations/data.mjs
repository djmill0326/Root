var area = "/music/ssdl/Locations/Pea%20Pod/Pea%20";
...
function realEncodeURI(uri) {
    ...
    if (url.includes(small_print))
        return "/music/museic/Absolution/11%20The%20Small%20Print.flac";
    if (url.includes(fine_print))
        return "/music/ssdl/Requests/Take%20Me%20to%20Your%20Leader/13%20The%20Fine%20Print.flac";
